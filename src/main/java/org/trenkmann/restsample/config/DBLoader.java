		...
		String[] templates = {
			     ...
			     IntStream.range(0, 100)
			       .forEach(i -> {
			         ...
			         MP3 mp3 = new MP3(random.nextInt(1000-200) + 200, String.format(template, buzzword), String.format(firstName, lastname), album, random.nextInt(60-59)+59 + ":" + random.nextInt(60-59)+59, random.nextInt(5-4)+5);

			         mP3Repository.save(mp3);

			         logger.info("JPA-Data Entry = {}", mp3.toString());
